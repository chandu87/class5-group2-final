                      ...
                      {contextType.isLoggedIn & this.props.displayFooter ? 
                        <div className="card-footer">
                            <div className="network-edit-button">
                                <a href={`/Internships/edit/${item.id}`} className="btn btn-outline-danger btn-sm"> Edit</a>
                                <a href={`/Internships/delete/${item.id}`} className="btn btn-outline-danger btn-sm">Delete</a>
                            </div>
                        </div>
                        : ""} 
                    </div>
