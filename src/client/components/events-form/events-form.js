    ...
    render(){
        ...
        return(
            <div className="container">    
                ...
                <br/>
                <div>
                    <a className="btn btn-outline-danger btn-sm network-edit-button" href="/Events/add"><FontAwesomeIcon icon="plus"/> Add Event</a>
                    <a className="btn btn-outline-danger network-edit-button btn-sm" href={`/Events/edit/${this.props.match.params.id}`}><FontAwesomeIcon icon="edit"/> Edit</a>
                    <a className="btn btn-outline-danger btn-sm" href="/Events"><FontAwesomeIcon icon="caret-square-left"/> Go back</a>
                </div>
